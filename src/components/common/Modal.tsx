...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Card */}
      <div
        className={`relative w-full ${maxWidthClasses} my-8 bg-white border border-slate-200/90 rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh] z-10 animate-scale-up text-slate-800`}
      >
        {/* Header */}
